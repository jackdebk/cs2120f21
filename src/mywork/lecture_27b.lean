...
begin
  unfold bijective inverse,
  unfold surjective injective,
  unfold total_function,
  unfold function defined,
  unfold single_valued,
  assume bi,
  cases bi with sur inj,
  cases sur with total h,
  cases inj with total i,
  cases total with func defined,
  apply and.intro,
  apply and.intro,
  apply and.intro,
  assume x y z,
...
begin
  ...
  assume bi,
  cases bi with sur inj,
  cases sur with total s,
  cases inj with total i,
  cases total with func e,
  unfold inverse,
end
...
begin
  ...
  assume inj,
  cases inj with total i,
  cases total with function defined,
  assume x y z,
  exact i,
end 
...
def bij_trans (s : β → γ → Prop)  (r : α → β → Prop) :
  ...
  begin
    unfold bijective,
    unfold surjective injective,
    unfold total_function composition,
    unfold function defined,
    unfold single_valued,
    assume bir bis,
    cases bir with surr injr,
    cases surr with total sr,
    cases injr with total ir,
    cases total with func defined,
    cases bis with surs injs,
    cases surs with totals ss,
    cases totals with funcs d,
    apply and.intro,
    apply and.intro,
    apply and.intro,
    assume x y z,
    ...
    cases e with b p, 
    cases e1 with b1 p1,
    cases p with sby rxb,
    cases p1 with sb1z rxb1,
    have beqb1 : b = b1 := func rxb rxb1,
    have sbz : s b z,
      rw beqb1,
      exact sb1z,
    exact funcs sby sbz,
    assume a,
    cases defined a with b1,
    cases injs with totals is,
    cases totals with funcs defs,
    cases defs b1 with b,
    ...
    assume e1,
    cases e1 with b1,
    cases e_h with sby rxb,
    cases e1_h with sb1z rxb1,
    have beqb1 : b = b1 := func rxb rxb1,
    have sbz : s b z,
      rw beqb1,
      exact sb1z,
    exact funcs sby sbz,
    assume a,
    cases total with func tr,
    cases tr a with b1,
    cases injs with totals is,
    cases totals with funcs ts,
    cases ts b1 with b,
    apply exists.intro b,
    apply exists.intro b1,
    apply and.intro h_1 h,
    ...
    cases e with b,
    cases e1 with b1,
    cases e_h with sbz rxb,
    cases e1_h with sb1z ryb1,
    cases injs with totals is,
    have beqb1 : b = b1 := is sbz sb1z,
    have ryb : r y b,
    rw beqb1,
    exact ryb1,
    exact ir rxb ryb,
